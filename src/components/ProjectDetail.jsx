...
const ProjectDetail = () => {
                    ...
                    <header className="project__header">
                        <div className="project__text">
                            ...
                            <div className="project__buttons">
                                <Link to="/" className="btn btn--outline" aria-label="목록으로">목록으로</Link>
                            </div>
                        </div>
                    </header>
                </div>
    ...
    const { img, imgName, title, code, view, meta = {}, detailImg = {}, detailImgAlt = {} } = item;
    const imageSrc = img || "/images/placeholder.jpg";
    const imageAlt = imgName || `${title} 미리보기`;

    return (
        <section id="projectDetail" className="project__wapper project__wapper-yorizori">
            <div className="project__inner">
                <div className="project__header">
                    <div className="project__header-inner">
                        <h2 className="project__title">{title}</h2>
                        <div className="project__about" aria-label="프로젝트 개요">
                            {/* <div className="project__about-row oneLine">
                                <p>{meta.oneLine || "-"}</p>
                            </div> */}
                            ...
                            <section className="project__article-section">
                                ...
                                <ul className="project__article-section-inner" aria-label="프로젝트 소개">
                                    <li className="section__card intro">
                                        <h4>{meta.oneLine || "-"}</h4>
                                        <p >요리조리는 요리를 매개로 사람들을 연결하는 모임 기반 커뮤니티 플랫폼입니다. 사용자는 다양한 요리 모임을 등록하거나 참여할 수 있고, 서로의 레시피와 후기를 공유하면서 요리 경험을 나눌 수 있습니다.</p>
                                    </li>
                                </ul>
                            </section>
                            <section className="project__article-section">
                                ...
                                <ul className="project__article-section-inner" aria-label="핵심 기능">
                                    <li className="section__card">
                                        ...
                                        <p>회원 탈퇴 시에는 사용자가 작성한 게시글, 댓글, 찜, 참여 기록 등 모든 관련 데이터가 자동으로 정리되도록 설계하여 데이터 정합성을 유지했습니다.</p>
                                    </li>
                                    <li className="section__card">
                                        <h4>모임 등록 / 수정 / 삭제</h4>
                                    ...
                                    <li className="section__card">
                                        <h4>관심 모임 저장</h4>
                                        <p>로컬스토리지 기반 스냅샷을 활용해 서버 요청 없이도 즉각적인 하트 토글 반응을 제공합니다.</p>
                                        <p>동시에 PocketBase의 `post_likes` 컬렉션과 연동하여 사용자의 찜 상태를 저장하고, 클라이언트와 서버 간의 데이터 일관성을 유지했습니다.</p>
                                    </li>
                                    <li className="section__card">
                                        <h4>댓글 시스템</h4>
                                    ...
                                    <li className="section__card">
                                        <h4>모임 예약 및 취소</h4>
                                        <p>사용자는 각 모임에 참여하거나 취소할 수 있으며, 인원 제한에 도달하면 자동으로 모집 마감 상태로 전환</p>
                                        <p>여러 사용자가 동시에 클릭할 경우를 대비해 중복 요청 방지 로직을 추가해 데이터 불일치를 예방</p>
                                    </li>
                                    <li className="section__card">
                                        <h4>반응형 + 다크모드 + Skeleton</h4>
                                        <p>모바일, 태블릿, 데스크톱 해상도별로 레이아웃이 최적화되어 있으며 Tailwind 기반 다크모드를 제공</p>
                                        <p>또한 Skeleton 로딩 UI를 적용해 데이터 로딩 시에도 시각적 일관성을 유지하고, 사용자 피드백 경험을 향상</p>
                                    </li>
                                    <li className="section__card">
                            ...
                            <section className="project__article-section">
                                ...
                                <ul className="project__article-section-inner" aria-label="회고록">
                                    <li className="section__card">
                                        ...
                                        <span className="card_inner">
                                            <p>프로젝트를 구현하며 상태 관리보다 중요한 것은 “데이터 구조의 일관성”이라는 걸 배웠습니다. 특히 PocketBase를 이용하면서 관계형 데이터 설계의 중요성, 클라이언트에서의 실시간 동기화 처리를 직접 체득했습니다. UI 측면에서는 “즉각적인 피드백”과 “자연스러운 인터랙션”에 집중했습니다. Skeleton, 다크모드, 버튼 상태 변화 등 작은 디테일들이 사용자 경험을 얼마나 풍부하게 만드는지 느낄 수 있었어요. 마지막으로, 기능을 쌓는 것보다 하나의 기능을 끝까지 완성도 있게 구현하는 것의 중요성을 깨달았고, 그 덕분에 지금은 코드를 짤 때 “유지보수성과 사용자 경험”을 항상 함께 생각하게 되었습니다.
                                            </p>
                                        </span>
                                    </li>
                                </ul>
